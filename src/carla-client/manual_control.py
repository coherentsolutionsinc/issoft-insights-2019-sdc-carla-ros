...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            # create spawn point
            spawn_point.location.x = 10.673355102539062
            spawn_point.location.y = -15.980005264282227
            spawn_point.location.z = 2.0
            spawn_point.rotation.yaw = -138.94577026367188
...
class CameraManager(object):
    def __init__(self, parent_actor, hud):
        ...
        self._camera_transforms = [
        #carla.Transform(carla.Location(x=1, z=1.0)),
        carla.Transform(carla.Location(x=0.7, z=1.7), carla.Rotation(pitch=-0.5))]
